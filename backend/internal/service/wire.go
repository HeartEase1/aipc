...
var ProviderSet = wire.NewSet(
	...
	ProvideBenefitGrantService,
	ProvideDiscountCampaignService,
...
func ProvidePaymentService(entClient *dbent.Client, registry *payment.Registry, loadBalancer payment.LoadBalancer, redeemService *RedeemService, subscriptionSvc *SubscriptionService, configService *PaymentConfigService, userRepo UserRepository, groupRepo GroupRepository, affiliateService *AffiliateService, notificationEmailService *NotificationEmailService, db *sql.DB, images *ImageStorageSettingService) *PaymentService {
	svc := NewPaymentService(entClient, registry, loadBalancer, redeemService, subscriptionSvc, configService, userRepo, groupRepo, affiliateService, db)
	svc.SetNotificationEmailService(notificationEmailService)
	svc.bonusImages = images
	return svc
}
