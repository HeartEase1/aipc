...
func (h *ChannelHandler) GetModelDefaultPricing(c *gin.Context) {
	...
	maxMultiplier := pricing.MaxReasoningEffortMultiplier
	if maxMultiplier == nil {
		maxMultiplier = service.DefaultMaxReasoningEffortMultiplier(model)
	}
	response.Success(c, gin.H{
		"max_reasoning_effort_multiplier": maxMultiplier,
		"found":                           true,
