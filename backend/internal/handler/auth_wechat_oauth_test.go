...
func TestWeChatPaymentOAuthCallbackRedirectsWithOpaqueResumeToken(t *testing.T) {
	...
	req.AddCookie(encodedCookie(wechatPaymentOAuthContextName, `{"payment_type":"wxpay","amount":"12.5","order_type":"subscription","plan_id":7,"subscription_action":"restart"}`))
	...
	require.Equal(t, payment.SubscriptionActionRestart, claims.SubscriptionAction)
