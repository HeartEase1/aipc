...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	benefitGrantHandler := handler.NewBenefitGrantHandler(benefitGrantService)
	...
	adminBenefitGrantHandler := admin.NewBenefitGrantHandler(benefitGrantService, totpService, userService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, leaderboardHandler, redeemHandler, subscriptionHandler, announcementHandler, benefitGrantHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
