export default {
    ...
    subscriptions: {
      ...
      resetInDaysHoursMinutes: '{days} 天 {hours} 小时 {minutes} 分钟后重置',
      ...
      quotaEndsInDaysHoursMinutes: '额度将在 {days} 天 {hours} 小时 {minutes} 分钟后结束',
      daysRemaining: '剩余 {days} 天',
      daysHoursMinutesRemaining: '剩余 {days} 天 {hours} 小时 {minutes} 分钟',
