...
export default {
  channelMonitorV2: {
    ...
    overview: {
      ...
      summaryHint: '展示各渠道分组当前状态与所选时间范围内的统计区间',
      legend: '健康状态图例',
      totalGroups: '监控分组',
      healthyGroups: '运行良好',
      attentionGroups: '需要关注',
      noDataGroups: '待评估',
      recentTrend: '近期状态',
      viewDetails: '查看详情',
      openDetailsFor: '查看 {name} 的详细分析',
      noTrafficAt: '{time} · 暂无流量',
      insufficientSamplesAt: '{time} · 有流量，样本不足',
      advancedTitle: '详细分析',
      advancedHint: '筛选渠道并查看完整矩阵、趋势、模型、错误原因和用户排行',
    ...
    metrics: {
      ...
      cacheDetail: '读缓存占比',
      successRate: '成功率',
      windowSuccessRate: '区间成功率',
      windowCacheRate: '区间缓存率',
      successRateValue: '成功率 {value}',
      healthSuccessRateValue: '健康口径成功率 {value}',
