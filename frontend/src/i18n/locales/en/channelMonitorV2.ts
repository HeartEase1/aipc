...
export default {
  channelMonitorV2: {
    ...
    overview: {
      ...
      summaryHint: 'Current status and statistics in the selected range for each channel group',
      legend: 'Health status legend',
      totalGroups: 'Monitored groups',
      healthyGroups: 'Operational',
      attentionGroups: 'Needs attention',
      noDataGroups: 'Pending rating',
      recentTrend: 'Recent health',
      userRate: 'User rate {rate}',
      viewDetails: 'View details',
      openDetailsFor: 'View detailed analysis for {name}',
      noTrafficAt: '{time} · no traffic',
      insufficientSamplesAt: '{time} · traffic present, insufficient samples',
      advancedTitle: 'Detailed analysis',
      advancedHint: 'Filter channels and inspect the full matrix, trends, models, errors, and user ranking',
    ...
    metrics: {
      ...
      windowSuccessRate: 'Success rate',
      windowCacheRate: 'Cache rate',
      successRateValue: 'Success rate {value}',
      healthSuccessRateValue: 'Health-adjusted success {value}',
