export default {
    accounts: {
      syncUpstreamCapabilitiesPartial: 'Model list synced. Some capabilities were saved; other models remain incomplete.',
      syncUpstreamCapabilitiesIncomplete: 'Model list synced, but capabilities are incomplete. Existing capability snapshots were retained.',
