export default {
    accounts: {
      ...
      openai: {
        ...
        codexCLIOnlyDesc:
          'Applies to OpenAI OAuth and API Key accounts. When enabled, only Codex official clients that pass identity and fingerprint checks are allowed; when disabled, existing access behavior is preserved.',
      ...
      pelicanTest: {
        defaultPrompt: 'Create a standalone HTML page with an SVG 2D animation of a pelican riding a bicycle.',
        deliveryContract: 'Return complete standalone HTML only, without Markdown fences, explanations, or external dependencies. Previews run in an isolated sandbox with external resource loading restricted.',
        reasoningDefault: 'Model default (omit reasoning parameter)',
        reasoningHint: 'Levels follow account mappings and model capabilities. Ultra is a client orchestration mode, not a single generation effort.',
        effort: { none: 'None', minimal: 'Minimal', low: 'Low', medium: 'Medium', high: 'High', xhigh: 'Extra high (xhigh)', max: 'Maximum (max)' },
        clearHistory: 'Clear this account history',
        stopAndClose: 'Stop and close',
        incompleteResponse: 'The stream did not finish successfully. Partial output is preserved below.',
        menu: 'Pelican Test',
        title: 'Pelican Test',
        ...
        model: 'Model',
        modelHint: 'Search available account models or enter a custom model ID. Prefers gpt-6-astra when available.',
        reasoning: 'Reasoning effort',
        reasoningLow: 'Low',
        reasoningMedium: 'Medium',
        reasoningHigh: 'High',
        parallel: 'Parallel runs',
        parallelHint: 'Up to 8 parallel outputs; each uses upstream quota. The browser keeps the latest 8 runs per administrator, using at most about 4 MB.',
        results: 'New Test',
