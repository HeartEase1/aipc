export default {
    ...
    subscriptions: {
      ...
      resetInDaysHoursMinutes: 'Resets in {days}d {hours}h {minutes}m',
      ...
      quotaEndsInDaysHoursMinutes: 'Quota ends in {days}d {hours}h {minutes}m',
      daysRemaining: '{days} days remaining',
      daysHoursMinutesRemaining: '{days}d {hours}h {minutes}m remaining',
