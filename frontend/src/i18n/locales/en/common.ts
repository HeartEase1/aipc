export default {
  ...
  onlinePlayground: {
    ...
    description: 'Use your site API key for multi-turn chat, image generation, and image editing.',
    configuration: 'Playground configuration',
    textChat: 'Multi-window chat',
    imageGeneration: 'Image generation',
    selectKey: 'API key',
    selectKeyPlaceholder: 'Choose an active key',
    unnamedKey: 'Unnamed key',
    selectTextModel: 'Chat model',
    selectImageModel: 'Image model',
    selectModelPlaceholder: 'Choose a model',
    base64Images: 'Return Base64 image data',
    base64ImagesHint: 'Prefer inline image data to avoid cross-origin limits. Providers that do not support it keep the original URL for copying.',
    base64ImagesOn: 'Base64 image data is enabled',
    base64ImagesOff: 'Disabled; use the image URL returned by the provider',
    keyPrivacyNotice: 'Saving records only the key ID, models, and image preference in this browser; it never stores the key value. The key value is used only in this page\'s memory and never placed in the URL, chats, or local history. Requests still use this site\'s gateway and existing billing. Agent may make multiple billable requests for one task, capped at 6 chat rounds and 6 image requests per action.',
    loadingKeys: 'Loading active keys…',
    loadingModels: 'Loading models…',
    keysLoadFailed: 'Could not load API keys. Check your connection and try again.',
    modelsLoadFailed: 'Could not load models with this key. Check the key, group, and IP restrictions.',
    httpStatus: 'Request status: {status}',
    noActiveKey: 'No active API key',
    createKeyHint: 'Create and enable a key before opening the playground.',
    goToKeys: 'Create an API key',
    saveConfiguration: 'Save configuration',
    configurationSaved: 'Configuration saved',
    saveConfigurationFailed: 'The browser could not save this configuration. Check whether site storage is disabled.',
    refreshModels: 'Refresh models',
    retry: 'Retry',
    workspace: 'Online creative workspace',
    iframeTitle: 'Online chat and image playground',
    connecting: 'Connecting to the playground…',
    connected: 'Playground connected',
    connectionFailed: 'Playground connection failed',
    connectionFailedHint: 'The playground assets may not be built yet or the connection timed out. Reconnect to try again.',
    reconnect: 'Reconnect',
    enterFullscreen: 'Open workspace in fullscreen',
    exitFullscreen: 'Exit fullscreen',
    localHistoryNotice: 'Conversations, tasks, and images stay in separate per-account browser storage and are never synced to the cloud. Other people using the same browser profile may access local data, so clear this site\'s browser data after using a shared device.'
  },
  ...
  leaderboard: {
    ...
    participationHint: 'Exclude me from rankings and totals when off',
    ...
    rebateTab: 'Rebates',
    summaryScope: 'Totals include all participating users within the selected period.',
    usageRule: 'Ranked by tokens used. All row values are totals for the selected period.',
    consumptionRule: 'Ranked by actual amount spent. All row values are totals for the selected period.',
    rebateRule: 'Ranked by rebate amount. Invitees are newly bound users within the selected period.',
    shareOverview: 'Share of total',
    usageShareDescription: 'Calculated by tokens used, showing each top-20 user and all other participants as a share of total tokens.',
    consumptionShareDescription: 'Calculated by amount spent, showing each top-20 user and all other participants as a share of total spending.',
    rebateShareDescription: 'Calculated by rebate amount, showing each top-20 user and all other participants as a share of total rebates.',
    otherUsers: 'Others',
    top20: 'Top 20',
    myData: 'My data',
    ...
    totalInvitedUsers: 'Total invitees',
    totalRebateCount: 'Total rebates',
