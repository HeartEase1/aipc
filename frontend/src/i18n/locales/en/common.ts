export default {
  ...
  onlinePlayground: {
    ...
    keyPrivacyNotice: 'The key is used only in this page\'s memory and never placed in the URL, chats, or local history. Requests still use this site\'s gateway and existing billing. Agent may make multiple billable requests for one task, capped at 6 chat rounds and 6 image requests per action.',
