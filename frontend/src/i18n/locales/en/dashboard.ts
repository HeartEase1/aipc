export default {
  ...
  keys: {
    ...
    fastMode: 'Fast mode',
    fastModeHint: 'This key requests Priority for OpenAI traffic, subject to the global Fast/Flex policy. Charges follow the actual tier and group pricing rules. Other providers are unaffected.',
  ...
  usage: {
    ...
    outputRateDetails: 'How output rates are calculated',
    outputRateAverage: 'Average output rate (includes first-token wait)',
    outputRateGeneration: 'Generation rate (excludes first-token wait)',
    outputRateAverageFormula: 'Output tokens / total duration, measured from the start of the request',
    outputRateGenerationFormula: 'Output tokens / generation duration, measured from the first output',
    outputRateGenerationWarning: 'Generation rate better reflects output speed after the response begins, but is affected by upstream timing and event buffering and is for reference only.',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
