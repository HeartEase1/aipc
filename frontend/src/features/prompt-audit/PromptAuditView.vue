<template>
  <AppLayout>
    ...
    <div v-if="draft && activeTab === 'config'" class="prompt-audit-save-bar fixed inset-x-0 bottom-0 z-30 border-t border-gray-200 bg-white/95 px-4 py-3 shadow-[0_-12px_35px_rgba(15,23,42,0.08)] backdrop-blur dark:border-dark-700/80 dark:bg-dark-900/95 dark:shadow-[0_-12px_35px_rgba(0,0,0,0.35)]">
...
@media (min-width: 1024px) {
  .prompt-audit-save-bar {
    left: var(--console-sidebar-effective-width, 16rem);
    transition: left var(--console-motion-normal, 300ms) var(--console-ease-standard, ease);
  }
}
</style>
