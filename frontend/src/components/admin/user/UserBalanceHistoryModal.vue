...
const typeOptions = computed(() => [
  ...
  { value: 'welfare', label: t('admin.users.typeWelfare') },
...
const isAdminType = (type: string) => ['admin_balance', 'admin_concurrency', 'welfare', 'compensation'].includes(type)

// Helper: check if balance type (includes admin_balance)
const isBalanceType = (type: string) => ['balance', 'admin_balance', 'affiliate_balance', 'welfare', 'compensation'].includes(type)
...
const getItemTitle = (item: BalanceHistoryItem) => {
  switch (item.type) {
    ...
    case 'welfare':
      return t('admin.users.balanceAddedWelfare')
    case 'compensation':
      return t('admin.users.balanceAddedCompensation')
    case 'concurrency':
