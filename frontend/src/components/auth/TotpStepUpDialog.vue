<template>
  <Teleport to="body">
    <div
      ...
      class="totp-step-up-overlay fixed inset-0 z-[160] overflow-y-auto"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div class="flex min-h-full items-center justify-center p-4">
        ...
        <div class="totp-step-up-dialog relative w-full max-w-md transform rounded-xl bg-white p-6 shadow-xl transition-all dark:bg-dark-800">
          ...
          <div class="mb-6">
            ...
            <div class="flex justify-center gap-2">
              <input
                ...
                pattern="[0-9]"
                autocomplete="off"
                class="totp-step-up-code-input h-12 w-10 rounded-lg border border-gray-300 text-center text-lg font-semibold focus:border-primary-500 focus:ring-primary-500 dark:border-dark-600 dark:bg-dark-700"
                :disabled="verifying"
