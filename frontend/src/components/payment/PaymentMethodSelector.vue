  ...
  <div>
    ...
    >
      <button
        ...
        :class="[
          'relative flex min-h-[60px] min-w-0 items-center rounded-lg border px-3 py-3 transition-all',
          !method.available
      ...
      >
        <span class="flex w-full min-w-0 items-center gap-3">
          ...
          <span class="flex min-w-0 flex-col items-start gap-1 leading-tight">
            <span data-testid="payment-method-label" class="block w-full whitespace-normal break-words text-left text-base font-semibold">
              {{ methodLabel(method) }}
            </span>
            <span
