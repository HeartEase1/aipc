...
const GITHUB_REPO = 'HeartEase1/aipc'
// AIPC GHCR image published by CI (tags carry no "v" prefix, e.g. ghcr.io/heartease1/aipc:1.0.0)
const DOCKER_IMAGE = 'ghcr.io/heartease1/aipc'
