...
This directory contains files for deploying AIPC, a Sub2API-compatible gateway, on Linux servers and Apple-silicon Macs.
...
AIPC supports three methods to connect to Gemini:
...
AIPC supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
