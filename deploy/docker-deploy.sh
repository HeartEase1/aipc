#!/bin/bash
# =============================================================================
# AIPC Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for AIPC:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/HeartEase1/aipc/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  AIPC Deployment Preparation"
    echo "=========================================="
    echo ""
