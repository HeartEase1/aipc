...
AIPC can run as a native three-service stack with Apple's `container` CLI. This workflow runs the published AIPC, PostgreSQL, and Redis OCI images without Docker Desktop or a Docker-compatible daemon.
...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/heartease1/aipc:latest
...
SUB2API_IMAGE=ghcr.io/heartease1/aipc:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
