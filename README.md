...
- Upstream changes are reviewed and selectively merged instead of being copied wholesale. Each release should be read as an AIPC release, not as an official Sub2API release.
